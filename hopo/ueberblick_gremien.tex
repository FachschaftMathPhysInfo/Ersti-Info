...
Die Fachschaft besteht im Groben aus zwei Organen: Der Fachschaftsvollversammlung (FSVV) und der Fachschaftsratssitzung (auch Fachschaftssitzung genannt), wobei der Fachschaftsrat in der Regel aber nur gemeinsame Entscheidungen der Sitzung ausführt. Die fünf Fachschaftsräte der jeweiligen Studienfachschaften können einmal im Jahr gewählt werden, in die Fachschaftssitzungen kommen kann aber jeder und hat automatisch ein Stimmrecht. Diese offene Struktur ist ein wesentlicher Unterschied zu den nichtöffentlich tagenden Universitätsgremien.

In unseren wöchentlichen Sitzungen beschäftigen wir uns als Fachschaft mit allerlei Themen und studentischen Belangen.
Es wird aus Gremien, in die wir Mitglieder entsenden, berichtet, über aktuelle Probleme einzelner Module diskutiert, Veranstaltungen werden geplant und Grundsatzmeinungen formuliert. Die Sitzungseinladungen sind in der Regel drei Tage vorher online\footnote{\url{https://www.mathphys.info/einladung-zur-gemeinsamen-sitzung/}} zu finden und im Anschluss findet ihr dort auch ein Protokoll\footnote{\url{https://www.mathphys.info/protokolle/}}. Außerdem bieten wir unseren Studentinnen allerlei Serviceleistungen durch unseren Fachschaftsdienst: Man kann sich im Fachschaftsraum Altklausuren und Prüfungsberichte ausleihen und um allerlei Rat fragen. Viele Fragen können wir selbst beantworten und wenn nicht, kennen wir oft die richtigen Ansprechpersonen.
...
Im Studierendenrat kommen Vertreterinnen aus fast allen 50 Studienfachschaften zusammen.
...
Dort wird unter anderem über eingereichte Finanzanträge entschieden, denn über den Semesterbeitrag zahlen alle Studentinnen einen Beitrag von \EUR{\vsbeitrag} an die VS, wovon 5,50€ an zentraler Stelle vergeben und 4,50€ an die Fachschaften weitergegeben wird.
Außerdem wird auch hier aus Gremien berichtet, es werden Kandidatinnen in Gremien gewählt, Satzungen oder Ordnungen beschlossen und vor allem wird über alle allgemeinen Belange des studentischen Lebens diskutiert.
...
Für spezifische Anliegen und Projekte sind die Referate die besten Ansprechpartnerinnen, zum Beispiel das Kulturreferat, wenn die Sperrzeiten in der Altstadt sich (mal wieder) ändern sollen.
...
In Deutschland ist Bildung Ländersache, deshalb richtet sich bei uns erstmal alles nach dem Landeshochschulgesetz (LHG) von Baden"=Württemberg.
...
Auf den Bundesfachschaftentagungen (BuFaTas) -- Konferenz der deutschsprachigen Mathematikfachschaften (KoMa), Konferenz der Informatik"=Fachschaften (KIF) und Zusammenkunft aller Physik"=Fachschaften (ZaPF) -- treffen sich Studentinnen der jeweiligen Fächer aus dem gesamten deutschsprachigen Gebiet jedes Semester.
