...
% Bitte niemal irgendwann wieder verwenden, solange nicht debugged!
    ...
    \begin{tabular*}{0.77\textwidth}{ll}
        \multicolumn{2}{l}{
            \parbox{0.77\textwidth}{
                Der Redaktionsschluss für diesen Text war am 08.09.2017. Wir freuen uns
...
%            \href{http://mobrinkmann.de}{Coverbild: Moritz Brinkmann} \href{http://creativecommons.org/licenses/by-sa/4.0/}{(CC-BY-SA)}\\ %2015 
	    \href{http://mntl.de}{Coverbild: Maximilian Jalea} \href{http://creativecommons.org/licenses/by-sa/4.0/}{(CC-BY-SA)}\\ %2017
