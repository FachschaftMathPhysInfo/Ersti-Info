...
\subsubsection*{Praktische Informatik, Programmierkurs und Algorithmen \& Datenstrukturen}
...
\begin{description}
	\item[Bastian]{ist ein Vorlesungs-Skript, was es auch bei uns im Fachschaftsraum kostenlos in gedruckter
	...
	\item[Cormen: Algorithms]{ist sozusagen die Algorithmen-Bibel. Jede Art von Sortier-, Textbearbeitungs-,
	Graphen- und Hashing-Algorithmen werden hier in Pseudocodes und mit bildlich dargestellten
	...
	Informatiker und ist ein kompetenter Wegbegleiter für die Vorlesung Algorithmen und Datenstrukturen.}
