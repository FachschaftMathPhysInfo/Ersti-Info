...
Viele Dozenten verwenden anstatt eines Buches ein eigens erstelltes Skript, was sich selber aus mehreren Büchern bedient oder komplett eigenständig ist. Dadurch sind sie natürlich perfekt auf die Vorelesung angepasst und sollten eure erste Quelle sein. Finden tut man die in der Regel auf der E-learning Seite der Vorlesung oder vielleicht sogar direkt im Internet. Teilweise ``borgen'' sich ihr Skript von anderen Dozenten, es lohnt sich also auch mal Skripte zu vergleichen.
