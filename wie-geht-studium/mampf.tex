...
Die Mathematische Medienplattform\footnote{\url{https://mampf.mathi.uni-heidelberg.de/}} (MaMpf) gibt es seit 2016 und wurde von Dr. Denis Vogel initiiert. Vor der Erweiterung um den Übungsbetrieb im letzten Jahr war MaMpf hauptsächlich E-Learning-Plattform mit umfassenden Lernangeboten, von denen sich viele speziell an Erstis richten:

\subsection{Übungsblätter abgeben}
Fast jede Mathematikvorlesung nutzt Mampf zur Zettelabgabe. Unter \grqq Übungen\grqq\ findest du das aktuelle Übungsblatt. Kommen beim rechnen Fragen auf oder vermutest du, dass in der Aufgabenstellung ein Fehler ist (das kommmt bei Grundvorlesungen eigentich eher nicht vor, später im Studium dafür umso häufiger), kannst du die Kommentarfunktion nutzen. Kommentare von Kommilitoninnen findest du unter \grqq i\grqq\ .\\
Um dein Übungsblatt abzugeben, kannst unter \grqq Abgaben\grqq\ die Datei hochladen. Mampf hat eine Dateigrößenobergrenze, ist die Datei zu groß, bietet dir die Seite an, sie zu komprimieren, das dauert allerdings recht lang und ist nicht umbedingt erfolgsgekrönt, besser benutzt du ein eigenes Datenkompressionstool oder versuchst, deine digitalen Notizen als PDF zu exportieren. Vergiss nicht deine Zettelpartnerinnen zur Abgabe einzuladen, die richtige Tutorin auszuwählen und am Ende auf Speichern zu drücken.
