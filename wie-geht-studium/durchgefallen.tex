...
Eine Ausnahme von dieser Regelung stellt die sogenannte Orientierungsprüfung dar. Diese Prüfung soll feststellen, ob ihr überhaupt geeignet seid, das Fach, das ihr studiert, zu studieren. Diese Prüfung müsst ihr, im Gegensatz zu allen anderen Prüfungen, bis spätestens zum Ende des dritten Semesters bestanden haben und die Jokerregelung gilt hier nicht. Dafür habt ihr dort auch mehr Prüfungsversuche, in der Mathematik und Informatik zum Beispiel vier.

\subsection{Muss ich nochmal Zettel rechnen?}
In der Mathematik und Informatik sind Klausurzulassungen ein Jahr gültig. Dort müsst ihr das also nicht. In der Physik kommt das auf die Dozentin eurer Veranstaltung an. Es gibt einige, die finden, dass man die Zettel nicht nochmal rechnen muss, einige wollen, dass ihr die Zulassung nochmal neu erwerbt. So oder so ist es unglaublich hilfreich, die Zettel trotzdem nochmal zu rechnen. Zwei Mal die gleiche Veranstaltung bei zwei verschiedenen Professorinnen ist eben doch ein Unterschied, und dass ihr Nachholbedarf habt, habt ihr ja schon gezeigt ;)
