...
\newcommand{\studienberatungphysik}{Björn Malte Schäfer (Studienbeginn), Tilman Enss (theoretische Physik), Stephanie Hansmann-Menzemer (Experimentalphysik), Selim Jochim (Doppelfach und Lehramt) und Andreas Just (Astronomie)} %https://physik.uni-heidelberg.de/studienberatung
...
\newcommand{\pruefsekinfofotoemail}{sekretariat@informatik.uni-heidelberg.de}
