...
%\hspace*{-6mm}
\begin{figure*}
   % \includegraphics[width=\linewidth]{bilder/altstadt_cmyk.pdf}
   \includegraphics[width=\linewidth]{bilder/altstadt_sw.png}
\end{figure*}
%
...
\begin{description}
    ...
    \place{Mohr}{Untere Straße 3}{Spät abends meist so voll, dass man gar nicht mehr rein kommt. Drinnen wird dafür allerdings auf den Tischen getanzt. Donnerstags gibt's zur Ladies’ Night kostenlosen Sekt für die Damen.}{$\star\ \star$}

    \place{Palmbräugasse}{Hauptstraße 185}{Hier gibt's das selbstgebraute Palmbräu. Palmen gehören zwar nicht typisch zu Heidelberg, aber die Schnitzel in der Palm\-bräu\-gasse schon.}{$\star\ \star\ \star$}
    ...
    \place{Mels}{Heiliggeiststraße 1}{Gewölbekeller, in dem seit Jahren die selbe Musik läuft, aber zumindest weiß man dann, was einen erwartet. Haben unter der Woche immer sehr gute Spezialangebote.}{$\star\ \star$}
    ...
    \place{Coyote Café}{Hauptstraße 130}{Einer der Orte, um eine Kneipentour durch die Altstadt zu starten. Weizenbier, Cocktails und Shots sind brauchbar und brauchen nicht ewig. Am späteren Abend gibt es häufig eine Happy Hour, bei der Cocktails nur die Hälfte kosten.}{$\star\ \star$}
    ...
    \place{Karlstorbahnhof}{Am Karlstor}{Richtig gute Diskothek (im Gebäude gibt's auch Theater, Lesungen etc. -- viel Kultur) mit sehr variabler Musik. Was zum Tanzen und weniger zum Trinken, denn die Preise können sich meistens sehen lassen, genauso der Eintritt.}{$\star\ \star\ \star$}
    ...
    \place{Medoc}{Bismarckplatz}{Café/Restaurant, das wechselnde Mittagsgerichte anbietet. Man kann draußen sitzen und den Betrieb auf dem Bismarckplatz beobachten.}{$\star\ \star$}
    ...
    \place{Regie}{Theaterstraße 2}{Riesenauswahl an Cocktails, die nach Filmen benannt und meist recht schick dekoriert sind. Cooles Specials- und Aktionensystem und leckere Flammkuchen.}{$\star\ \star\ \star$}

    \place{Tangente}{Kettengasse 23}{Hoher Juristinnenanteil und teils ältere Menschen. Türsteher und Gesichtskontrolle, dafür aber kein Eintritt. Hier kann man gut Tanzen, sollte aber keine Platzangst haben.}{$\star\ \star$}
    ...
    \place{Vetters}{Steingasse 9}{Nicht zum Bleiben, aber für die Maß to go, die schmeckt da hervorrangend. Ansonsten gutbürgerliche Küche, älteres Klientel und viele Touristinnen. Brauen das Bier mit dem höchsten Stammwürzegehalt der Welt (33\%).}{$\star\ \star$}
    ...
    \place{Café Villa}{Hauptstraße 187}{Cocktailbar. Ab 18 Uhr Happy Hour.%, alle Cocktails \EUR{4}
    }
    {$\star\ \star$}
\end{description}
...
\begin{description}
    ...
    \place{Bar 133}{Wohnheim \gls{INF} 133}{Wohnheimsbar, eigentlich nur für Bewohner der 100-er Wohnheime. Mittwochs und sonntags geöffnet mit gutem Angebot, günstigen Cocktails und Tischkicker.}{$\star$}
    ...
    \place{Ma Bar}{ Wohnheim \gls{INF} 384}{Eine neu eröffnete Bar bei den Wohnheimen. Neben Essen und Getränken gibt es dorch auch Regelmäßige Events wie z.b Public Viewing.}{$\star$}
    ...
    \place{Cappuccino}{Bergheimer Straße 8}{Hippe Mischung von Kaffeehaus mit lautem Elektro.}{$\star\ \star$}
