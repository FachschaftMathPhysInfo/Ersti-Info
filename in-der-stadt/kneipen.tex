...
\begin{description}
    ...
    \place{Mels}{Heiliggeiststraße 1}{Gewölbekeller, in dem seit Jahren die selbe Musik läuft, aber zumindest weiß man dann, was einen erwartet. Haben unter der Woche immer sehr gute Spezialangebote z.B. dienstags 123-Party (Shots \EUR{1}, Weizen \EUR{2}, Cocktails \EUR{3}).}{$\star\ \star$}
    ...
    \place{Ben's Burgerbar}{Hauptstraße 142}{gibt's nicht mehr}
...
\begin{description}
    ...
    \place{Ma Bar}{ Wohnheim \gls{INF} 384}{Eine neu eröffnete Bar bei den Wohnheimen. Neben Essen und Getränken gibt es dorch auch Regelmäßige Events wie z.b Public Viewing.}{$\stars$}
