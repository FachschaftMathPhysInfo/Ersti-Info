...
Im zweiten Semester ist es vorteilhaft, \vl{Betriebssysteme \& Netzwerke} (\gls{IBN}) zu besuchen, da diese Vorlesung gut an dieser Stelle des Studiums zu schaffen ist. Grundlage für weitere Vorlesungen ist oft die Vorlesung \vl{Algorithmen \& Datenstrukturen}, da diese aber ein paar Mathematikkenntnisse erfordert, wartet diese am besten ab, bis ihr die erste Mathematik-Veranstaltung gehört habt.
...
Studiert ihr den 50\%-Bachelor mit Lehramtsoption, dann müsst ihr noch das Modul \vl{Informatik und Gesellschaft} belegen. Meistens wird es im Wintersemester angeboten, selten auch mal im Sommersemester. Des Weiteren müsst ihr \vl{Fachdidaktik 1 Teil 2: Didaktik der Informatik} belegen.
