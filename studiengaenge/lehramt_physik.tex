...
Der 50\%-Bachelorstudiengang Physik ersetzt seit dem Wintersemester 2015/16 den Physik-Lehramtsstudiengang. Hier habt ihr die Wahl zwischen Physik 50\% mit und ohne Lehramtsoption. 
Die Lehramtsoption soll euch die notwendigen fachlichen Kompetenzen für den Physikunterricht beibringen und den Übergang zum Master of Education ermöglichen.
Wenn ihr den 50\%-Bachelor nutzt, weil ihr an zwei Fächern interessiert seid, aber nicht das Berufsziel Lehrerin anstrebt, solltet ihr ohne Lehramtsoption studieren. Sofern ihr die Bachelorarbeit im Fach Physik schreibt, ist anschließend der Übergang in den Master of Science Physik möglich.

Um euch einen Überblick über den Studienverlauf zu verschaffen, findet ihr im Modulhandbuch Modellstudienpläne. Dort könnt ihr auch die Varianten für 100\% Physik, 50\% Physik und 50\% Physik mit Lehramtsoption vergleichen.
...
Gemäß Prüfungsordnung dürft ihr den 50\%-Bachelor Physik mit Lehramtsoption mit allen anderen 50\%-Studiengängen an der Universität Heidelberg, die für einen Master of Education qualifizieren, kombinieren. Allerdings ist die Kombination mit Mathematik vorteilhaft, da ihr nur so mathematische Grundlagen erwerbt (sieht dazu den Abschnitt \nameref{mathegrundlagen}) und mit der Mathematik die zeitliche Überschneidungsfreiheit von Pflichtveranstaltungen noch am ehesten gewährleistet ist.

Unabhängig von der Fächerkombination dürft ihr am Ende dieses Studiums die Bachelorarbeit in Physik schreiben; müsst aber nicht. Ihr könnt euer erstes Lehramtsfach, in dem ihr die Bachelorarbeit schreiben wollt, auch unkompliziert im Laufe eures Studiums tauschen.
%TODO: Nachschauen welches Jahr gemeint ist
Während der 50\%-Bachelor ohne Lehramtsoption auf einen möglichen Master of Science in Physik vorbereiten soll, folgt auf den 50\%-Bachelor mit Lehramtsoption der Master of Education, welcher fachlich weniger in die Tiefe geht, dafür aber Inhalte der Bildungswissenschaften und Fachdidaktik vermittelt. Um diesen unterschiedlichen Ansprüchen der beiden 50\%-Bachelorstudiengänge gerecht zu werden, überarbeitet die Fakultät aktuell den Lehramtsstudienplan. Es gibt seit letztem Jahr eine neue dreiteilige Vorlesungsreihe \vl{Moderne Physik für Lehramt} (\gls{MoPhy}). Diese besteht aus drei aufeinanderfolgenden Vorlesungen, wobei die ersten beiden den Stoff aus den Vorlesungen \vl{Experimentalphysik 3}, \vl{4} und \vl{5} (\gls{Ex}), sowie \vl{Theoretische Physik 3} und \vl{4} (\gls{Theo}) behandeln. Die \gls{MoPhy} 3 geht darüber hinaus und bietet eine Einführung in die Umwelt- und Astrophysik.

In den ersten beiden Semestern hört man regulär die Ex~1 und~2. Bei der Ex~1 handelt es sich um die Orientierungsprüfung für den Studiengang Physik, die ihr am besten im ersten, spätestens aber im dritten Semester bestehen müsst. Im dritten und vierten Semester geht es dann nicht mit der Ex~3 und 4 weiter, sondern ihr startest die MoPhy~1 und 2. Parallel dazu hört ihr die Theo~1 und~2. Im sechsten Semester könnt ihr euch dann entscheiden: aktuell hast ihr die Wahl zwischen Ex~4 und Theo~4, je nachdem welche Vorlesung euch mehr interessiert. Ergänzt wird diese Vorlesung durch einen Programmierkurs. Lest am besten nochmal die aktuellen Regularien durch, wenn ihr soweit seid.

Eine weitere Neuerung betrifft euch bereits im ersten Semester: ihr könnt euch sowohl den \vl{Vorkurs} als auch den \vl{Basiskurs} für euer Lehramtsstudium anrechnen lassen. 

Ein Großteil der Arbeit ist auf die Vorlesungszeit konzentriert; in der vorlesungsfreien Zeit können Labor- und Schulpraktika durchgeführt werden. Während das \vl{Physikalische Anfängerpraktikum für Lehramt} (APL) für die Semesterferien nach dem zweiten Semester vorgesehen ist, könnt ihr das erste Schulpraktikum, die sogenannte \vl{Berufsorientierende Praxisphase 1} (\gls{BOP}) nach Belieben zwischen dem ersten und fünften Semester absolvieren. Wenn ihr das Praktikum direkt nach dem ersten Semester durchführen möchtet, müsst ihr euch jedoch rechtzeitig zu Beginn des ersten Semesters anmelden.
...
Der polyvalente Bachelor mit 50\% Physikanteil soll für den Master of Science Physik qualifizieren. Das heißt, dass ihr die grundlegenden Vorlesungen \vl{Experimentalphysik 1-5} (\gls{Ex}) und \vl{Theoretische Physik 1-4} (\gls{Theo}) verpflichtend hören müsst. Ein Übergang in den Master of Science Physik ist jedoch nur möglich, wenn ihr die Bachelorarbeit im Fach Physik schreibst. Davon abgesehen macht es für den Studienverlauf keinen Unterschied, ob Physik euer erstes oder zweites Fach ist.
...
Für den Fall, dass ihr als anderes Fach Mathematik gewählt hast, hört ihr im ersten Semester noch \vl{Analysis 1} (\gls{Ana}) und \vl{Lineare Algebra 1} (\gls{LA}).
...
Allerdings sind nicht ohne Grund für den 100\%-Bachelorstudiengang Physik die Vorlesungen \gls{LA}~1 und \gls{Ana}~2 und 3 oder \vl{Höhere Mathematik für Physiker 1}, \vl{2} und \vl{3} (\gls{HoMa}) vorgeschrieben. Zum Beispiel ist die theoretische Beschreibung der Quantenmechanik ohne Kenntnis über Eigenvektoren aus \gls{LA}~1 nicht zu verstehen. Das Beste wäre also, wenn all jene, die nicht Mathematik als zweites Fach gewählt haben, zumindest \gls{LA}~1 vor \gls{Theo}~4 hören (oder ein Buch lesen) würden. Diese Vorlesungen sind im Modellstudienplan allerdings nicht vorgesehen, wodurch dies quasi freiwillige Zusatzarbeit wäre, da das 50\%-Studium keinerlei Spielraum für zusätzliche Leistungspunkte aus Wahlfächern vorsieht.
