...
\textbf{Aufgepasst!} Die \gls{IPI} ist in der Informatik eure einzige \emph{Orientierungsprüfung} und ihr müsst sie bis zum Ende des dritten Semesters bestanden haben. Falls Ihr das nicht schafft werdet Ihr exmatrikuliert und verliert Ihr euren Prüfungsanspruch in gesamt Deutschland. Das gilt es also tunlichst zu vermeiden.
...
\begin{itemize}
    ...
    \item Oder ihr entscheidet euch für \vl{Mathematik für Informatiker 1} (\gls{MafIn} bzw. IMI, entspricht etwa \gls{LA} 1) im ersten und \vl{Mathematik für Informatiker 2} (ersetzt \gls{Ana} 1) im zweiten Semester. Weiteres dazu auf \autopageref{mafin}. 
\end{itemize}
