...
\begin{figure*}
    ...
    \begin{subfigure}{.2\textwidth}
	    \includegraphics[width=3cm]{bilder/cant_sleep_1.png}
    \end{subfigure}
    \begin{subfigure}{.2\textwidth}
	    \includegraphics[width=3cm]{bilder/cant_sleep_2.png}
    \end{subfigure}
    \begin{subfigure}{.2\textwidth}
	    \includegraphics[width=3cm]{bilder/cant_sleep_3.png}
    \end{subfigure}
    \begin{subfigure}{.2\textwidth}
...
%Sollte hier nicht vielleicht noch die Theoretische Informatik auftauchen?
