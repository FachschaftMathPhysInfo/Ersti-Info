...
%todo Seminare und Praktika
Außerdem müsst ihr noch ein Proseminar, ein Seminar sowie ein Anfänger-- und ein Fortgeschrittenen Praktikum machen. Diese Unterscheiden sich in sofern von den ganzen Vorlesungen da von den Modulen her keine Inhaltliches Thema vorgegeben ist sondern lediglich die Veranstaltungsform.

In Seminar und Proseminar müsst ihr euch zu einem Thema, das zu Beginn zugeteilt wird, genau informieren und dann einen Vortrag halten in dem ihr die Restlichen Seminar Teilnehmern das Thema erklärt. Natürlich werden euch von den Anderen Teilnehmern Thematisch ähnliche Dinge Erklärt. Während bei einem Proseminar Theoretisch mehr auf das Wie der Vortrag gehalten wird und so ankommt. Ist es bei dem Seminar vor allem wichtig einen Inhaltlich guten Vortrag zu halten, aber meist ist diese Trennung gar nicht so klar.

Bei den Praktika bekommt ihr ein Software Projekt das ihr, in einer Gruppe von Zwei bis Drei Leuten, innerhalb eines Semesters Schreiben soll. Dabei habt ihr meist viel Freiheit wie ihr euch die Zeit und die Arbeit einteilt da ihr lediglich zum Semester ende fertig sein müsst. Das Anfänger-- und Fortgeschrittenen Praktikum unterscheidet sich eigentlich nur in seiner Komplexität.
