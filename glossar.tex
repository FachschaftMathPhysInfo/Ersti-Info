...
\newglossaryentry{IfI}{
	...
	description={Das Institut für Informatik ist eines der Institute der Fakultät für Mathematik und Informatik und sitzt im Mathematikon. Die Mitglieder decken unter anderem ein Großteil der Lehre im Bereich Informatik ab}
}
...
\newglossaryentry{LP}{
	...
	description={Leistungspunkte, auch Credit Points (CP) oder ECTS (European Transfer Credit System) genannt, sind ein Maß für den Aufwand eines Moduls. Dabei sollte ein CP etwa 30 Stunden Arbeit entsprechen -- das kommt aber öfter nicht als hin}
}
...
\newglossaryentry{ITP}{
	...
	description={Das Institut für Theoretische Physik bevölkert die meisten Uni-Ge\-bäu\-de am Philosophenweg. Ihr findet die Dozenten und Mitarbeiter in den Gebäuden Philosophenweg 12, 16 und 19. Außerdem gibt es insbesondere in der 12 noch einige Seminarräume und den studentischen Arbeitsraum\footnote{mehr zum Arbeitsraum siehe Seite \pageref{sec:arbeitsraum}}}
}
...
%Informatik
\newglossaryentry{IPI}{name=IPI, description={Die Vorlesung Einführung in die Praktische Informatik, wird manchmal auch Info1 gennant}}
...
%Physik
\newglossaryentry{Ex}{name=Ex, description={Die Vorlesungen Experimentalphysik I bis V}}
\newglossaryentry{HöMa}{name=HöMa, description={Die Vorlesungen Höhere Mathematik für Physiker II und III}}
%Physik&Info
\newglossaryentry{Theo}{name=Theo, description={Physik: Die Vorlesungen Theoretische Physik I bis IV. Informatik: Die Vorlesung Einführung in die Theoretische Informatik, im Modulhandbuch mit ITH abgekürzt}}
\newglossaryentry{AP}{name=AP, description={Physik: Das Physikalische Praktikum für Anfänger I und II, meist Anfängerpraktikum genannt oder wie im Modulhandbuch mit PAP1 bzw. PAP2 abgekürzt. Informatik: Das (Software)-Anfängerpraktikum}}
\newglossaryentry{FP}{name=FP, description={Physik: Das Physikalische Fortgeschrittenen-Praktikum I und II, meist Fortgeschrittenenpraktikum genannt oder wie im Modulhandbuch mit PFP1 bzw. PFP2 abgekürzt. Informatik: Das (Software)-Fortgeschrittenenpraktikum}}
