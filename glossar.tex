...
\newglossaryentry{CP}{
	...
	description={Credit Points (CP), auch Leistungspunkte (LP) oder \gls{ECTS} (European Transfer Credit System) genannt, sind ein Maß für den Aufwand eines Moduls. Dabei sollte ein CP etwa 30 Stunden Arbeit entsprechen -- das kommt aber öfter nicht als hin.}
}

\newglossaryentri{LP}{
	name={LP},
	first={Leitsungspunkte (LP)},
	description={siehe \Gls{CP}}
}

\newglossaryentry{ECTS}{
	name={ECTS},
	first={European Credit Transfer System},
	description={Die Erfindung , die uns Leistungspunkte beschert hat. Wird häufig auch dafür verwendet, siehe \Gls{CP}}
}
