...
\newglossaryentry{HeiCO}{
    ...
    description={Die Platform, über die alle Studienverwaltungsaufgaben laufen: Übungsgruppen, Klausurzulassung und -anmeldung, Notenspiegel, Immatrikulationsbescheinigung und Überweisungsdetails für den Semesterbeitrag}
}
...
\newglossaryentry{FSWE}{
    ...
    description={Das Fachschaftswochenende veranstalten wir einmal pro Semester, um Themen diskutieren zu können, die sich nicht sinnvoll in einer Fachschaftssitzung unterbringen lassen. Und natürlich um jede Menge Spaß zu haben \smiley.}
}
...
\newglossaryentry{IMI}{name=IMI, description={siehe \gls{MafIn}}}
