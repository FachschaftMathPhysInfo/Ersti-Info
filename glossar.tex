...
% \newglossaryentry{electrolyte}{name=electrolyte, description={solution able to conduct electric cnnurrent}}
...
\newglossaryentry{c.t.}{name={c.t.}, description={lat.: cum tempore, mit Zeit, also eine Viertelstundeee später}}
...
\newglossaryentry{URZ}{
    ...
    description={Das Universitätsrechenzentrum stellt alles bereit, was sich grob mit dem Begriff \emph{Computer} in Verbindung bringen lässt.}
}

\newglossaryentry{HeiCO}{
    name={HeiCO},
    first={Heidelberg Campus online},
    description={Die Plattform, über die alle Studienverwaltungsaufgaben laufen: Übungsgruppen, Klausurzulassung und -anmeldung, Notenspiegel, Immatrikulationsbescheinigung und Überweisungsdetails für den Semesterbeitrag}
}
...
\newglossaryentry{IAM}{
    ...
    description={Institut für Angewandte Mathematik, siehe \Gls{AM}}
}

\newglossaryentry{MI}{
    name={MI},
    first={Mathematisches Institut},
    description={Das Mathematische Institut -- auch Reine Mathematik genannt -- ist eines der Institute der Fakultät für Mathematik und Informatik und sitzt im Mathematikon im 3. OG}
}
...
\newglossaryentry{Mathematikon}{
    name={Mathematikon},
    first={Mathematikon},
    description={Das Mathematikon (INF 205) ist das 2017 neu eröffnete Ge\-bäu\-de an der Berliner Straße, in dem die Fakultät für Mathematik und Informatik und das IWR untergebracht sind. Dort finden auch die meisten Seminare, Übungen und kleineren Vorlesungen statt. Außerdem befindet sich dort die Bereichsbibliothek, einige Arbeitsplätze und natürlich die Fachschaft}
}
...
\newglossaryentry{StuRa-Buero}{
    name={StuRa-Büro},
    first={StuRa-Büro},
    description={am Philosophenweg. Büro- und Tagungsräume für den StuRa und andere studentische Gruppen. Auch die Sozialberatung u.ä. finden hier statt. Die genaue Adresse ist Albert-Ueberle-Straße 3-5, 69120 Heidelberg}
}


\newacronym{UB}{UB}{Universitätsbibliothek}
\newacronym{OPNV}{ÖPNV}{Öffentlicher Personennahverkehr}
\newacronym{INF}{INF}{Im Neuenheimer Feld}
\newacronym{HS}{HS}{Hörsaal}
\newacronym{gHS}{gHS}{großer Hörsaal}
\newglossaryentry{FSWE}{
    name={FSWE},
    first={Fachschaftswochenende (FSWE)},
    description={Das Fachschaftswochenende veranstalten wir einmal pro Semester, um Themen diskutieren zu können, die sich nicht sinnvoll in einer Fachschaftssitzung unterbringen lassen. Und natürlich, um jede Menge Spaß zu haben \smiley \dots}
}
...
\newglossaryentry{LP}{
    ...
    description={Leistungspunkte -- auch Credit Points (CP) oder ECTS (European Transfer Credit System) genannt -- sind ein Maß für den Aufwand eines Moduls. Dabei sollte ein LP etwa 30 Stunden Arbeit entsprechen -- das kommt aber öfter nicht hin}
    % TODO adjust last sentence
}
\newglossaryentry{CP}{
    name={CP},
    description={Credit Points, siehe \Gls{LP}}
}
...
\newglossaryentry{PI}{
    ...
    description={Das Physikalische Institut (INF 226) wird des Öfteren auch Klaus-Tschira-Gebäude genannt. Es handelt sich dabei um eines der neueren Gebäude im Feld. Dort finden eure ersten verpflichtenden Physikpraktika statt, welche aus diversen Versuchen bestehen. Hier findet ihr auch den zweiten Fachschaftsraum (Raum 00.200) im \gls{PAP}-Gang}
}
\newglossaryentry{ITP}{
    name={ITP},
...
%Informatik
\newglossaryentry{IPI}{name=IPI, description={Die Vorlesung Einführung in die Praktische Informatik}}
...
\newglossaryentry{IBN}{name=IBN, description={Die Vorlesung Betriebssysteme und Netzwerke.}}
...
\newglossaryentry{IMI}{name=IMI, description={Die Vorlesungen Mathematik für Informatiker 1 und 2, im  Modulhandbuch mit IMI abgekürzt}}
...
\newglossaryentry{Ana}{name=Ana, description={Die Vorlesungen Analysis 1 und 2 sowie Höhere Analysis -- letztere wird oft auch Analysis 3 genannt}}
...
\newglossaryentry{FunkTheo}{name=Funktheo, description={Die Vorlesung Funktionentheorie 1}}
%Physik
\newglossaryentry{Ex}{name=Ex, description={Die Vorlesungen Experimentalphysik 1 bis~5}}
\newglossaryentry{HoMa}{name=HöMa, description={Die Vorlesungen Höhere Mathematik für Physiker 1 bis 3}}
%Physik&Info
\newglossaryentry{Theo}{name=Theo, description={Physik: Die Vorlesungen Theoretische Physik 1 bis 4.}}
\newglossaryentry{ITH}{name=ITH, description={Die Vorlesung Einführung in die Theoretische Informatik}}
\newglossaryentry{PAP}{name=PAP, description={Physik: Das Physikalische Praktikum für Anfänger 1 und 2, meist Anfängerpraktikum genannt oder wie im Modulhandbuch mit PAP1 bzw. PAP2 abgekürzt. }}
\newglossaryentry{AP}{name=AP, description={Das (Software)-Anfängerpraktikum im Bachelor Informatik}}
...
\newglossaryentry{IWR}{name=IWR, description={Interdisziplinäres Zentrum für Wissenschaftliches Rechnen mit Sitz im Mathematikon. Brücke zwischen der Mathematik und Informatik und der Physik.}}
...
\newglossaryentry{audiMAX}{
name={audiMAX},
description={Das frisch fertiggestellte Hörsaalzentrum auf dem Campus. Beinhalted die Zweigstelle Neuenheim der Unibib und die größten Hörsäle im Feld. }}
