...
Im Uni-Alltag benötigt ihr zahlreiche digitale Tools, die teilweise von der Universität selbst, teilweise von externen Anbietern gehostet werden. Dementsprechend sind sie manchmal frei zugänglich und manchmal benötigt ihr einen Account; meist euren Uni-Account.

\hspace{1cm}

\begin{figure*}[b]
	\centering
	\includegraphics[width=.6\textwidth]{bilder/14_different_standarts.png}
\end{figure*}

{\ifthenelse{\boolean{druckversion}}{
		\includegraphics[width=.5\linewidth]{bilder/heiCO_logo_mon.jpg}
	}{
		\includegraphics[width=0.5\linewidth]{bilder/heiCO_logo.jpg}
}}

\begin{description}[style=nextline]
    \item[\href{https://heico.uni-heidelberg.de/} {heiCO} \vspace*{2mm} ]
	
	Kennt ihr schon aus dem Immatrikulationsverfahren, im Uni-Betrieb nur über den VPN der Uni oder aus dem Uni-Netz (eduroam) erreichbar. Über HeiCo läuft fast alles Organisatorische im Studium, dazu gehören:
	
	\begin{description}
		\item[Veranstaltungssuche] Wollt ihr wissen, wann ihr eigentlich wo für eure erste Vorlesung sein sollt, oder was für Vorlesungen es überhaupt gibt, könnt ihr unter \grqq Lehrveranstaltungen\grqq\ danach suchen. Die Suchleiste hat allerdings keinerlei Fehlertoleranz, es kann deshalb einfacher sein, unter \grqq Studiengang\grqq\ den eigenen Studiengang zu wählen, um in der nun eingeschränkten Veranstaltungsliste notfalls manuell suchen zu können.\\
		Habt ihr eure Wunschveranstaltung gefunden, könnt ihr euch hoffentlich unter \grqq Zur LV-Anmeldung \grqq\ anmelden, sollte es diesen Knopf nicht geben, könnt ihr auf der Seite der Vorlesung den Stern wählen, um euch die Vorlessung zumindest vorzumerken. Wichtig ist, dass ihr euch (wenn die Anmeldung geöffnet ist) für Vorlesung und Übung zur Vorlesung anmeldet, das sind in HeiCO zwei separate Lehrveranstaltungen. Sonst könnt ihr euch später nicht für die Klausur anmelden.
		
		\item[Prüfungsanmeldung] Normalerweise (in der Physik ist das anders) bedeutet für eine Vorlesung angemeldet sein nicht automatisch auch für die Prüfung angemeldet sein, ihr werdet also einige Wochen vor dem Klausurtermin eine E-Mail kriegen, dass die Anmeldung auf HeiCO eröffnet ist. Dann könnt ihr auf \grqq Prüfungstermine\grqq\ eure Veranstaltung suchen und euch für die Klausur anmelden. Ob die Anmeldung erfolgt ist, könnt ihr auf \grqq Meine Prüfungstermine\grqq\ überprüfen.\\
		Selten kann es passieren, dass HeiCO euch aus leicht mysteriösen Gründen von einer Prüfung wieder abmeldet, es lohnt sich also, seine E-Mails regelmäßig zu lesen. Sollte das der Fall sein, wendet euch an die Obertutorin der Vorlesung oder an das Prüfungssekretariat (Kontakt auf \autopageref{pruefsek}). Das Gleiche gilt, wenn ihr merkt, dass ihr doch die Anmeldung zur Übung zur Vorlesung vergessen haben solltet.
		
		\item[Rückmeldung] ist eine seltsame Art, Zahlung des Semesterbeitrags zu sagen. Über \grqq Studienbeitragsstatus\grqq\ erfahrt ihr, an welches Konto ihr wie viel Geld bis wann überweisen müsst, und ob es angekommen ist.
		
		\item[Bescheinigungen] Unter \grqq Bescheinigungen und Dokumente\grqq\ findet ihr Immatrikulationsbescheinigungen und unter \grqq Meine Leistungen\grqq\ den Transcript of records.
		
		\item[Ein einradfahrender Waschbär]
		
		\begin{minipage}{0.55\linewidth}
			\vspace{1.5mm}
			Der Ladebildschirm-Waschbär ist dafür zuständig, eure Daten sicher von den Prüfungssekretariaten im Feld zur zentralen Universitätsverwaltung in der Altstadt zu fahren.
		\end{minipage}
		\begin{minipage}{0.4\linewidth}
			{\ifthenelse{\boolean{druckversion}}{
					\includegraphics[width=\linewidth]{bilder/heiCO_waschbär_mon.jpg}
				}{
					\includegraphics[width=\linewidth]{bilder/heiCO_waschbär.jpg}
			}}
		\end{minipage}
		\hfill
	...
	{\ifthenelse{\boolean{druckversion}}{
			\includegraphics[width=.9\linewidth]{bilder/moodle_logo_mon.jpg}
		}{
			\includegraphics[width=0.9\linewidth]{bilder/moodle_logo.png}
	}}

	\item[\href{https://moodle.uni-heidelberg.de}{Moodle}]
    E-Learning-Plattform der Uni, auf der in manchen Vorlesungen (besonders in der Informatik) Lernmaterialien, Zettelabgaben, Punkteeinsicht und organisatorische Informationen angeboten werden. Ist nur über den VPN der Uni (zur Installation siehe nächste Seite) oder aus dem Uni-Netz (eduroam) erreichbar.

	\label{PhÜ}
	\item[\href{https://uebungen.physik.uni-heidelberg.de}{PhÜ (Physik-Übungsgruppen)}]
    Der Name ist Programm. Hier könnt ihr euch in der Physik in Übungsgruppen eintragen, zu Veranstaltungen anmelden sowie Punkte für Übungszettel und die Klausurnoten einsehen. Integriert Rocket-Chatrooms, die teilweise für die Kommunikation mit den Tutorinnen genutzt werden. Außerdem gibt es bei manchen Vorlesungen eine Zettelpartnerinnen-Tauschbörse, bei der ihr euch in euer Wunschtutorium, in dem z.B. eure Zettelpartnerinnen schon drin sind, reintauschen könnt.

	\item[\href{https://muesli.mathi.uni-heidelberg.de}{MÜSLI}]
    In der Mathe und Info wurden mit diesem System bis zum letzten Semester die Übungsgruppen organisiert. Das wird jetzt auch über MaMpf gemacht\footnote{Das MaMpf mampf das MÜSLI.}, nur in ganz wenigen Fällen wird diese Plattform noch genutzt. Es ist also gut möglich, dass ihr euch gar keinen Account für MÜSLI erstellen müsst.

	\item[\href{https://mampf.mathi.uni-heidelberg.de}{MaMpf (Mathematische Medienplattform)}]
    MaMpf bündelt und vernetzt verschiedene E-Learning-Angebote: Vorlesungsvideos und Skripte mit inhaltlicher Gliederung, Übungsblätter, eine umfangreiche Sammlung von Multiple-Choice-Fragen und Quizaufgaben inklusive angeleiteter Beweise und seit dem Wintersemester (2026/2027) eben auch den Übungsbetrieb der Vorlesung. Mehr Infos zu dieser Plattform auf \autopageref{mampf}.
...
Auf dem RFID-Chip der Karte ist nur die ID für die Bezahlfunktion des Studierendenwerks gespeichert und daher ist dies auch die einzige Information, die sich ohne Sichtverbindung auslesen lässt. 
...
Über das URZ kann man als Studentin auch Lizenzen für verschiedene Programme und Betriebssysteme bekommen. Zum Beispiel Microsoft Office 365 Pro Plus. Die Uni ist Teil eines Abkommens vom Land Baden-Württemberg mit Microsoft, wordurch alle Studentinnen sich das Office 365 Pro Plus Paket \emph{kostenlos} holen können. Alternativ können auch die Linux-kompatiblen und generell kostenlosen Dienste von beispielsweise OpenOffice und LibreOffice genutzt werden. Auch erwähnenswert ist Matlab, was für numerische Anwendungen ein praktisches Programm ist. Die gesamte aktuelle Liste findet ihr auf der URZ-Webseite\footnote{\url{https://www.urz.uni-heidelberg.de/de/service-katalog/software-und-anwendungen}}.
