...
\begin{description}
    ...
    Neues Campus-Management-System, das für alle studentischen Angelegenheiten wie Bewerbung, Zulassung, Prüfungs- und Übungsgruppenanmeldung, Bescheinigungen etc. verwendet wird. Das System ist aktuell noch etwas fehlermeldungsfreudig.

	\item[\href{https://moodle.uni-heidelberg.de}{Moodle}]
    E-Learning-Plattform der Uni, auf der in manchen Vorlesungen Lernmaterialien, Zettelabgaben, Punkteeinsicht, Klausuranmeldung und organisatorische Informationen angeboten werden. Vor allem für die Informatik relevant.
    ...
    In der Mathe und Info werden mit diesem System Übungsgruppen organisiert. Man kann sich in Übungsgruppen eintragen, zu Veranstaltungen und Klausuren anmelden und Punkte für Übungszettel und die Klausurnoten einsehen, wie viele dieser Funktionen durch das heiCO übernommen werden ist aktuell noch unklar, eure Professoren werden dies allerdings frühzeitig kommunizieren.
