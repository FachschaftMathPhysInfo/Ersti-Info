...
\begin{description}[style=nextline]
	...
	\begin{description}
		...
		\item[Prüfungsanmeldung] Normalerweise (in der Physik ist das anders) bedeutet für eine Vorlesung angemeldet sein nicht automatisch auch für die Prüfung angemeldet sein, ihr werdet also einige Wochen vor dem Klausur eine E-Mail kriegen, dass die Anmeldung auf HeiCO eröffnet ist. Dann könnt ihr auf \grqq Prüfungstermine\grqq\ eure Veranstaltung suchen, und euch für die Klausur anmelden. Ob die Anmeldung erfolgt ist, könnt ihr auf \grqq Meine Prüfungstermine\grqq\ überprüfen.\\
    ...
    Der Name ist Programm. Hier könnt ihr euch in der Physik in Übungsgruppen eintragen, zu Veranstaltungen anmelden sowie Punkte für Übungszettel und die Klausurnoten einsehen. Integriert Rocket-Chatrooms, die teilweise für die Kommunikation mit den Tutorinnen genutzt werden. Außerdem gibt es bei manchen Vorlesungen eine Zettelpartner-Tauschbörse, bei der ihr euch in euer Wunschtutorium, in dem z.B. eure Zettelpartner schon drin sind, reintauschen könnt.

	\item[\href{https://muesli.mathi.uni-heidelberg.de}{MÜSLI}]
    In der Mathe und Info wurden mit diesem System bis zum letzten Semester die Übungsgruppen organisiert. Das wird jetzt auch über MaMpf gemacht, nur in ganz wenigen Fällen wird diese Plattform genutzt. Es ist also gut möglich, dass ihr euch gar keinen Account für MÜSLI erstellen müsst.

	\item[\href{https://mampf.mathi.uni-heidelberg.de}{MaMpf (Mathematische Medienplattform)}]
    MaMpf bündelt und vernetzt verschiedene E-Learning-Angebote: Vorlesungsvideos und Skripte mit inhaltlicher Gliederung, Übungsblätter, eine umfangreiche Sammlung von Multiple-Choice-Fragen und Quizaufgaben inklusive angeleiteter Beweise und seit dem Wintersemester eben auch den Übungsbetrieb der Vorlesung. Mehr Infos zu dieser Plattform auf \autopageref{mampf}.
...
\subsection{E-Mail}
\vspace*{-1mm}
Mit der Freischaltung erhaltet ihr automatisch eine E-Mail-Adresse die auf \emph{@stud.uni-heidelberg.de} endet und momentan mit 10 GB Speicherplatz nicht so schlecht ausgestattet ist. Größter Vorteil ist ihre Werbefreiheit und sehr gute Verfügbarkeit. \textbf{Achtung:} Solltet ihr die Adresse trotz allem nicht verwenden wollen, ändert \emph{unbedingt} eure Stammdaten unter Studien- /Heimatadresse\footnote{\url{https://heico.uni-heidelberg.de}} und lasst euch die E-Mail-Adresse weiterleiten. Viele wichtige E-Mails wie die Rückmeldeerinnerung, Nachrichten von euren Tutorinnen oder Rundmails der Vorlesungen gehen dort ein. Das Mailprogramm Sogo ist nur aus dem Uni-Netz oder mit einer VPN zu erreichen. Auch, wenn ihr euch einen Mailclient wie Outlook oder Thunderbird einrichtet, benötigt ihr eine VPN-Verbindung, um Mails zu versenden oder zu empfangen.
